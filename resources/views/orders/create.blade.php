...
@section('content')
    <div class="container mx-auto mt-24 bg-gray-50 p-6 rounded-lg shadow-lg">
        <h1 class="text-4xl font-extrabold text-center text-gray-800 mb-10">Rendelés</h1>

        <div>
            <form class="max-w-md mx-auto" method="POST" action="{{ route('orders.store') }}">
                @csrf
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="customer_phone"
                        class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Telefonszám (+36 01 234 5678)</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <label for="service_id" class="block mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">Melyik szolgáltatásban érdekelt?</label>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <label for="comment" class="block mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">Megjegyzés</label>
                    <textarea id="comment" name="comment" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=""></textarea>
                </div>
                <button type="submit"
                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Rendelés leadása</button>
            </form>
